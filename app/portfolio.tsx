...
const projects: Project[] = [
  ...
  { id:"arg", name:"迷境 ARG 调查局", en:"MIJING ARG COMMUNITY", pitch:"玩家扮演调查员，从都市异闻、影像异常与文档缺页中整理可复核的证据链。", status:"在线整合", type:"ARG / 互动叙事", role:"叙事系统 / 调查流程 / 网页交互", tags:["ARG","互动叙事","证据链","社区协查"], image:"/media/projects/arg/01.webp", accent:"#c77b68", playable:true, playableHref:"https://mijing-arg-community.netlify.app/", playableLabel:"进入 ARG 调查局" },
